...
const SignIn = () => {
  ...
  const [successMsg, setSuccessMsg] = useState(""); // <-- Success message (NEW)
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!user) {
        ...
        login(user);
        setSuccessMsg("Welcome back! You have successfully signed in."); // <-- Set success msg
        setTimeout(() => setSuccessMsg(""), 5000); // Clear after 2.5s
