...
const SignUp = () => {
  ...
  // Show alert and, if successful, redirect after 5 seconds
  const showTemporaryAlert = (type, message, redirectPath = null) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      showTemporaryAlert('success', 'Account created successfully! Redirecting to sign in...', '/signin');
    } catch (error) {
      showTemporaryAlert('danger', 'Error creating account! Please try again.');
    } finally {
  ...
  return (
    <div>
      ...
      {/* Alert Message */}
      {alert.show && (
        <div className={`alert alert-${alert.type} text-center m-0 rounded-0`} role="alert" style={{ zIndex: 2000 }}>
          {alert.message}
        </div>
      )}
