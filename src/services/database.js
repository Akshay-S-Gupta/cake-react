...
export const products = [
  {
    ...
    category: "Donuts",
    description:
      "Delicious donuts with colorful sprinkles, perfect for any occasion. Made with fresh ingredients and topped with premium sprinkles.",
    images: [
    ...
    additionalInfo:
      "These donuts are made fresh daily with premium ingredients. Perfect for breakfast, dessert, or any special occasion.",
    shippingInfo:
    ...
    reviews: [
      {
        ...
        rating: 5,
        comment:
          "Absolutely delicious! The sprinkles are perfect and the donuts are so fresh.",
      },
      {
        id: 2,
  ...
  },
  {
    ...
    category: "Pastries",
    description:
      "Rich chocolate pastry with layers of cream and fresh berries.",
    images: [
    ...
    additionalInfo:
      "Made with premium Belgian chocolate and fresh seasonal berries.",
    shippingInfo:
      "Free shipping on orders over $50. Standard delivery 2-3 business days.",
    reviews: [],
  },
  ...
  },
  {
    ...
    additionalInfo:
      "Traditional red velvet cake perfect for special occasions.",
    shippingInfo:
      "Free shipping on orders over $50. Standard delivery 2-3 business days.",
    reviews: [],
  },
...
export const teamMembers = [
  {
    ...
    position: "Team Lead & Frontend Dev",
    image: "team/Akshay.jpg",
  },
  {
    id: 2,
    name: "Ms Anushka Kulkarni",
    position: "Middleware & Frontend Dev",
